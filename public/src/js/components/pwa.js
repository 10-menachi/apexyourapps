...
export default (() => {
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-body text-center">
              ...
              <h5 class="pt-1" id="${promptId}Label">Install Apex app</h5>
              ${
                  browser === "Safari"
                      ? `<p class="fs-sm mb-0">Add Apex to your home screen for quick and easy access to your shopping anytime, anywhere! Tap the <span class="fw-semibold">"Share"</span> icon in Safari and select <span class="fw-semibold">"Add to Home Screen"</span> from the options.</p>`
                      : `<p class="fs-sm mb-0">Add Apex to your home screen for quick and easy access to your shopping anytime, anywhere!</p>`
              }
    ...
    const setupPWAInstallation = () => {
        ...
        if (os === "iOS" && browser === "Safari") {
                ...
                document.body.addEventListener("click", (e) => {
                    ...
                    if (target.id === "installPWAButton") {
                        ...
                        const promptInstance =
                            bootstrap.Modal.getInstance(promptElement);
                        /* eslint-enable no-undef */
                        ...
                        deferredPrompt.userChoice.then((choiceResult) => {
                            if (choiceResult.outcome === "accepted") {
                                logMessage(
                                    "User accepted the A2HS prompt. PWA was installed"
                                );
                                localStorage.setItem(installedKey, true); // Set the installedKey value to true
                            } else {
            ...
            logMessage(
                "PWA installation is not supported on your device or browser."
            );
        }
    };
