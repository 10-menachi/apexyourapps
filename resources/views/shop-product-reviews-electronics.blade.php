            ...
            <div class="row">
                ...
                <div class="col-md-7 order-md-1">
                    ...
                    <div class="border-bottom py-3 mb-3">
                        ...
                        <p class="fs-sm">Overall, the iPhone 14 Plus was a solid upgrade for me. However, potential buyers
                            should weigh the high price against the incremental nature of the upgrades and consider their
                            specific needs before making a purchase.</p>
                        <ul class="list-unstyled fs-sm pb-2 mb-1">
                    ...
                    <div class="border-bottom py-3 mb-3">
                        ...
                        <p class="fs-sm">The iPhone 14 is nothing short of exceptional, combining cutting-edge technology
                            with a design that continues to set the standard for premium smartphones. That's why it deserves
                            a perfect 5-star rating.</p>
                        <ul class="list-unstyled fs-sm pb-2 mb-1">
                            <li><span class="text-dark-emphasis fw-medium">Pros:</span> Unparalleled performance, great
                                camera, stunning design</li>
                        ...
                        <div class="ps-3 pb-2">
                            <div class="d-flex align-items-center pt-3 pb-2 mb-1">
                                ...
                                <span class="h6 mb-0 me-4">Apex Company</span>
                                <span class="text-body-secondary fs-sm">May 8, 2024</span>
                            </div>
                            <p class="fs-sm mb-0">Thank you for your feedback! We are glad that you were satisfied with
                                your purchase :)</p>
                        </div>
                    </div>
                    ...
                    <div class="border-bottom py-3 mb-3">
                        ...
                        <p class="fs-sm">iPhone 14 is a reliable upgrade with notable improvements in performance and
                            camera quality. However, the higher price and the lack of groundbreaking design changes might
                            make potential buyers pause. If you're due for an upgrade
                        ...
                        <div class="d-flex gap-2 pt-1 pb-3">
                            <img src="assets/img/shop/electronics/product/reviews/01.png" class="d-block rounded-2 me-1"
                                width="86" alt="Image">
                            <img src="assets/img/shop/electronics/product/reviews/02.png" class="d-block rounded-2 me-1"
                                width="86" alt="Image">
                            <img src="assets/img/shop/electronics/product/reviews/03.png" class="d-block rounded-2 me-1"
                                width="86" alt="Image">
                        </div>
                        <div class="nav align-items-center">
                            <button type="button" class="nav-link animate-underline px-0">
                    ...
                    <div class="border-bottom py-3 mb-3">
                        ...
                        <p class="fs-sm">iPhone 14 impresses with its camera prowess, delivering high-quality images.
                            However, the decision to eliminate the 3.5mm headphone jack may impact users who rely on wired
                            audio accessories, requiring them to adapt to wireless
                            alternatives or use an adapter.</p>
                        <ul class="list-unstyled fs-sm pb-2 mb-1">
                            <li><span class="text-dark-emphasis fw-medium">Pros:</span> 12-megapixel ultra-wide lens and a
                                12-megapixel wide lens</li>
