                ...
                <div class="mb-5 col-lg-8 col-xl-7 position-relative z-2 mb-lg-0">
                    <div class="gap-5 accordion d-flex flex-column pe-lg-4 pe-xl-0" id="checkout">
                        ...
                        <div class="border-0 accordion-item d-flex align-items-start">
                            <div class="flex-shrink-0 d-flex align-items-center justify-content-center bg-body-secondary text-dark-emphasis rounded-circle" style="width: 2rem; height: 2rem; margin-top: -.125rem">
                            ...
                            <div class="w-100 ps-3 ps-md-4">
                                <div class="d-flex align-items-center">
                                    <h2 class="mb-0 accordion-header h5 me-3" id="deliveryInfoHeading">
                                        ...
                                        <button type="button" class="py-1 accordion-button collapsed fs-5 d-lg-none" data-bs-toggle="collapse" data-bs-target="#deliveryInfo" aria-expanded="false" aria-controls="deliveryInfo">
                        <span class="me-2">Delivery information</span>
                      </button>
                                    </h2>
                                    <div class="nav ms-auto">
                                        <a class="p-0 nav-link text-decoration-underline" href="checkout-v1-delivery-2.html">Edit</a>
                                    </div>
                                </div>
                            ...
                            <div class="w-100 ps-3 ps-md-4">
                                <div class="d-flex align-items-center">
                                    <h2 class="mb-0 accordion-header h5 me-3" id="shippingAddressHeading">
                                        ...
                                        <button type="button" class="py-1 accordion-button collapsed fs-5 d-lg-none" data-bs-toggle="collapse" data-bs-target="#shippingAddress" aria-expanded="false" aria-controls="shippingAddress">
                        <span class="me-2">Shipping address</span>
                      </button>
                                    </h2>
                                    <div class="nav ms-auto">
                                        <a class="p-0 nav-link text-decoration-underline" href="checkout-v1-shipping.html">Edit</a>
                                    </div>
                                </div>
                        ...
                        <div class="d-flex align-items-start">
                            <div class="flex-shrink-0 text-white d-flex align-items-center justify-content-center bg-primary rounded-circle fs-sm fw-semibold lh-1" style="width: 2rem; height: 2rem; margin-top: -.125rem">3</div>
                            <div class="w-100 ps-3 ps-md-4">
                                ...
                                <div class="mb-4" id="paymentMethod" role="list">
                                    ...
                                    <!-- Cash on delivery -->
                                    <div class="mt-4">
                                        <div class="mb-0 form-check" role="listitem" data-bs-toggle="collapse" data-bs-target="#cash" aria-expanded="false" aria-controls="cash">
                          ...
                          Cash on delivery
                                        ...
                                        <div class="collapse" id="cash" data-bs-parent="#paymentMethod">
                                            <div class="pt-3 pb-2 d-sm-flex align-items-center pt-sm-4 ps-3 ms-2 ms-sm-3">
                              ...
                              <i class="ci-dollar-sign"></i>
                                    ...
                                    <!-- Credit card -->
                                    <div class="mt-4">
                                        <div class="mb-0 form-check" role="listitem" data-bs-toggle="collapse" data-bs-target="#card" aria-expanded="true" aria-controls="card">
                          ...
                          <span class="gap-2 d-none d-sm-flex ms-3">
                            ...
                            <img src="assets/img/payment-methods/maestro.svg" width="36" alt="Maestro">
                                        ...
                                        <div class="collapse show" id="card" data-bs-parent="#paymentMethod">
                                            <form class="pt-4 pb-2 needs-validation ps-3 ms-2 ms-sm-3" novalidate="">
                                                <div class="mb-3 position-relative mb-sm-4" data-input-format="{&quot;creditCard&quot;: true}">
                                    ...
                                    <!-- PayPal -->
                                    <div class="mt-4">
                                        <div class="mb-0 form-check" role="listitem" data-bs-toggle="collapse" data-bs-target="#paypal" aria-expanded="false" aria-controls="paypal">
                                            <label class="form-check-label d-flex align-items-center text-dark-emphasis fw-semibold">
                          <input type="radio" class="form-check-input fs-base me-2 me-sm-3" name="payment-method">
                          PayPal
                          <img src="assets/img/payment-methods/paypal-icon.svg" class="ms-3" width="16" alt="PayPal">
                                    ...
                                    <!-- Google Pay -->
                                    <div class="mt-4">
                                        <div class="mb-0 form-check" role="listitem" data-bs-toggle="collapse" data-bs-target="#googlepay" aria-expanded="false" aria-controls="googlepay">
                                            <label class="form-check-label d-flex align-items-center text-dark-emphasis fw-semibold">
                          <input type="radio" class="form-check-input fs-base me-2 me-sm-3" name="payment-method">
                          Google Pay
                      ...
                      I accept the
                      <a class="p-0 nav-link text-decoration-underline fw-normal ms-1" href="terms-and-conditions.html">Terms and Conditions</a>
                    </label>
                                </div>
                            ...
                            <div class="p-sm-2 p-lg-0 p-xl-2">
                                <div class="pb-4 mb-4 border-bottom">
                                    <div class="mb-4 d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="nav">
                                            <a class="p-0 nav-link text-decoration-underline" href="checkout-v1-cart.html">Edit</a>
                                        </div>
                                    </div>
                                    <a class="gap-2 d-flex align-items-center text-decoration-none" href="#orderPreview" data-bs-toggle="offcanvas">
                                        <div class="ratio ratio-1x1" style="max-width: 64px">
                                            <img src="assets/img/shop/electronics/thumbs/08.png" class="p-1 d-block" alt="iPhone">
                                        </div>
                                        <div class="ratio ratio-1x1" style="max-width: 64px">
                                            <img src="assets/img/shop/electronics/thumbs/09.png" class="p-1 d-block" alt="iPad Pro">
                                        </div>
                                        <div class="ratio ratio-1x1" style="max-width: 64px">
                                            <img src="assets/img/shop/electronics/thumbs/01.png" class="p-1 d-block" alt="Smart Watch">
                                        </div>
