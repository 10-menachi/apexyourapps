...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Terms and Conditions</title>
        ...
        <div class="container py-5 mb-2 mt-n2 mt-sm-1 my-md-3 my-lg-4 mb-xl-5">
            <div class="row justify-content-center">
                <div class="col-lg-11 col-xl-10 col-xxl-9">
                    ...
                    <div class="h6 pt-2 pt-lg-3"><span class="text-body-secondary fw-medium">Last updated:</span>
                        June 26, 2024</div>
                    <p>Welcome to Apex! These Terms and Conditions ("Terms") govern your access to and use of the Apex
                        website and mobile application (collectively referred to as the "Platform"). Please read these
                    ...
                    <p>Apex provides an online platform that enables users to purchase groceries and other products from
                        local stores and have them delivered to their designated location. By using the Platform, you
                        acknowledge and agree that Apex
                        is not a store or retailer but merely acts as an intermediary to facilitate transactions between
                        users and participating stores.</p>
                    <p>Welcome to the family of websites and applications provided by Apex. These Terms of Use govern
                        your access to and use of all Apex Sites, among other things. By using the Apex Sites, you
                        affirm that you are of legal age
                        to enter into these Terms of Use, or, if you are not, that you have obtained parental or
                        guardian consent to enter into these Terms of Use and your parent or guardian consents to these
                        Terms of Use on your behalf. If you violate
                        or do not agree to these Terms of Use, then your access to and use of the Apex Sites is
                        unauthorized. Additional terms and conditions apply to some services offered on the Apex Sites
                        (e.g., Apex Pharmacy, Apex
                        +, and Gift Cards) or through other channels. Those terms and conditions can be found where the
                        relevant service is offered on the Apex Sites or otherwise and are incorporated into these Terms
                        of Use by reference.</p>

                    <h2 class="h4 pt-3 pt-lg-4">2. Your use of the Apex Sites</h2>
                    <p>You certify that the Content you provide on or through the Apex Sites is accurate and that the
                        information you provide on or through the Apex Sites is complete. You are solely responsible for
                        maintaining the confidentiality
                        and security of your account including username, password, and PIN. Apex is not responsible for
                        any losses arising out of the unauthorized use of your account. You agree that Apex does not
                        have any responsibility if you
                        lose or share access to your device. Any agreement between you and the issuer of your credit
                        card, debit card, or other form of payment will continue to govern your use of such payment
                        method on the Apex Sites. You agree that
                        Apex is not a party to any such agreement, nor is Apex responsible for the content, accuracy, or
                        unavailability of any method used for payment. Your account may be restricted or terminated for
                        any reason, at our sole
                        discretion. Except as otherwise provided by law, at any time without notice to you, we may (1)
                        change, restrict access to, suspend, or discontinue the Apex Sites or any portion of the Apex
                        Sites, and (2) charge, modify,
                        or waive any fees required to use any services, functionality, or other content available
                        through the Apex Sites or any portion of the Apex Sites.</p>
                    <h3 class="h6">In connection with the Apex Sites, you will not:</h3>
                    <ul class="gap-3">
                        <li>Make available any Content through or in connection with the Apex Sites that is or may be in
                            violation of the content guidelines set forth in Section 3.C (Prohibited Content) below.
                        </li>
                        <li>Make available through or in connection with the Apex Sites any virus, worm, Trojan horse,
                            Easter egg, time bomb, spyware, or other computer code, file, or program that is or is
                            potentially harmful or invasive or intended
                            to damage or hijack the operation of, or to monitor the use of, any hardware, software, or
                            equipment.</li>
                        <li>Use the Apex Sites for any commercial purpose, or for any purpose that is fraudulent or
                            otherwise tortious or unlawful.</li>
                        <li>Harvest or collect information about users of the Apex Sites.</li>
                        <li>Interfere with or disrupt the operation of the Apex Sites or the systems, servers, or
                            networks used to make the Apex Sites available, including by hacking or defacing any portion
                            of the Apex Sites; or violate any
                        ...
                        <li>Reproduce, modify, adapt, translate, create derivative works of, sell, rent, lease, loan,
                            timeshare, distribute, or otherwise exploit any portion of (or any use of) the Apex Sites
                            except as expressly authorized in these Terms
                            of Use, without Apex's express prior written consent.</li>
                        <li>Reverse engineer, decompile, or disassemble any portion of the Apex Sites, except where such
                            restriction is expressly prohibited by applicable law.</li>
                        <li>Remove any copyright, trademark, or other proprietary rights notice from the Apex Sites.
                        </li>
                        <li>You will not attempt to do anything, or permit, encourage, assist, or allow any third party
                            to do anything, prohibited in this Section, or attempt, permit, encourage, assist, or allow
                            any other violation of these Terms of Use.</li>
                    </ul>

                    <h2 class="h4 pt-3 pt-lg-4">3. Ordering and delivery</h2>
                    <p>When placing an order through Apex, you are responsible for ensuring the accuracy of the items,
                        quantities, and delivery details. Apex does not guarantee the availability of any specific
                        product and reserves the right to
                        substitute products based on availability. Delivery times provided are estimates and may vary
                        due to various factors.</p>
                    <ul class="gap-3">
                        <li>Reverse engineer, decompile, or disassemble any portion of the Apex Sites, except where such
                            restriction is expressly prohibited by applicable law.</li>
                        <li>Reproduce, modify, adapt, translate, create derivative works of, sell, rent, lease, loan,
                    ...
                    <p>Apex facilitates payments for orders made through the Platform. By using Apex's payment services,
                        you agree to provide accurate payment information and authorize Apex to charge the applicable
                        amount for your order. Apex
                        may use third-party payment processors to process transactions and may store your payment
                        information in accordance with its Privacy Policy.</p>

                    <h2 class="h4 pt-3 pt-lg-4">5. User conduct</h2>
                    <p>You agree to use the Platform in compliance with all applicable laws and regulations. You shall
                        not engage in any unlawful, harmful, or abusive behavior while using the Platform. Apex reserves
                    ...
                    <p>All content on the Apex Platform, including but not limited to text, graphics, logos, and
                        software, is the property of Apex or its licensors and is protected by intellectual property
                        laws. You may not use, reproduce, modify,
                        or distribute any content from the Platform without prior written consent from Apex.</p>
                    <h3 class="h6 pt-2">Third-party links and content</h3>
                    <p>The Platform may contain links to third-party websites or resources. Apex does not endorse,
                        control, or assume responsibility for any third-party content or websites. You acknowledge and
                        agree that Apex is not liable for
                    ...
                    <p>The Platform is provided on an "as is" and "as available" basis, without warranties of any kind,
                        either express or implied. Apex does not guarantee the accuracy, reliability, or availability of
                        the Platform and disclaims all warranties
                        to the fullest extent permitted by law.</p>
                    <h3 class="h6 pt-2">Limitation of liability</h3>
                    <p>To the maximum extent permitted by law, Apex and its affiliates shall not be liable for any
                        indirect, incidental, consequential, or punitive damages arising out of or in connection with
                        the use of the Platform, even if advised
                        of the possibility of such damages.</p>

                    <h2 class="h4 pt-3 pt-lg-4">6. Entire agreement and severability</h2>
                    <p>These Terms, subject to any amendments, modifications, or additional agreements you enter into
                        with Apex, shall constitute the entire agreement between you and Apex with respect to the
                        Services and any use of the Services.
                        If any provision of these Terms is found to be invalid by a court of competent jurisdiction,
                        that provision only will be limited to the minimum extent necessary, and the remaining
                        provisions will remain in full force and effect.</p>
                    <p>Apex reserves the right to modify or update these Terms at any time without prior notice. Your
                    ...
                    <p>If you have any questions, or comments about these Terms please contact Apex at:</p>
                    <ul class="list-unstyled pb-1">
                        ...
                        <li class="nav pt-1">
                            <a class="nav-link align-items-start fs-base p-0"
                                href="mailto:contact@catzillastore.com">
                    ...
                    <p class="pb-3 mb-0">For customer service inquiries, please review Your Account Settings, visit
                        Apex's <a class="fw-medium" href="help-topics-v1.html">Help Center.</a></p>
