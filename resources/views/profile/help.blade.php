                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">Is there an option for express delivery?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">Will my parcel be charged customs charges?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">I paid with Afterpay, how do returns work?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">Can I return an exchange instead of a refund?</a>
                                </li>
                            </ul>
                        </div>
                        <div class="pt-0 bg-transparent border-0 card-footer nav">
                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">My payment was declined, what should I do?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">Can I amend my order after I've placed it?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">What if isn't right on my customs invoice?</a>
                                </li>
                            </ul>
                        </div>
                        <div class="pt-0 bg-transparent border-0 card-footer nav">
                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">Where can I find your care instructions?</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">What are your adhesive product guidelines?</a>
                                </li>
                            </ul>
                        </div>
                        <div class="pt-0 bg-transparent border-0 card-footer nav">
                    ...
                    <div class="border-0 card h-100 bg-body-tertiary p-md-2">
                        <div class="card-body">
                            ...
                            <ul class="gap-3 nav flex-column">
                                ...
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                                        href="help-single-article-v1.html">I'm having trouble signing into my account.</a>
                                </li>
                                <li>
                                    <a class="p-0 nav-link hover-effect-underline fw-normal"
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <article class="swiper-slide">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="help-single-article-v1.html" style="--cz-aspect-ratio: calc(306 / 416 * 100%)">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="help-single-article-v1.html">When should I
                        ...
                        <article class="swiper-slide">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="help-single-article-v1.html">How can I find
                        ...
                        <article class="swiper-slide">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="help-single-article-v1.html">Will my parcel be
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="faqCollapse-7" aria-labelledby="faqHeading-7"
                                ...
                                <div class="accordion-body">Our comprehensive size guide is conveniently located on each
                                    ...
                                    size guide in the main menu under "Size Guide." We recommend referring to
                        ...
                        <div class="accordion-item">
                            ...
                            <div class="accordion-collapse collapse" id="faqCollapse-10" aria-labelledby="faqHeading-10"
                                ...
                                <div class="accordion-body">Once an order is confirmed, our system processes it promptly to
                                    ...
                                    this point. However, please contact our customer support as soon as
