...
@section('title', 'Admin Panel Customer Details')
@section('content')
            ...
            <div class="xl:w-full  min-h-[calc(100vh-138px)] relative pb-14">
                <div class="grid grid-cols-12 sm:grid-cols-12 md:grid-cols-12 lg:grid-cols-12 xl:grid-cols-12 gap-4">
                    <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-4 xl:col-span-3">
                        <div class="">
                            <div class="text-center">
                                <img src="admin-assets/images/users/avatar-1.png" alt=""
                                    class="rounded-full mx-auto inline-block">
                                <div class="my-4">
                                    <h5 class="text-xxl font-semibold text-slate-700 dark:text-gray-400">Merri Diamond
                                    </h5>
                            ...
                            <p class="dark:text-slate-400">Hi I'm Merri Diamond,has been the industry's standard dummy
                                text ever since the 1500s, when an unknown printer took a galley of type.</p>
                            <div class="mt-4 text-center">
                                <div
                                    class="border-2 border-slate-200/50 dark:border-slate-600/60 inline-flex rounded-full cursor-pointer">
                                    <img src="admin-assets/images/logos/facebook.png" alt=""
                                        class="rounded-full h-9 w-9">
                                </div>
                                <div
                                    class="border-2 border-slate-200/50 dark:border-slate-600/60 inline-flex rounded-full cursor-pointer">
                                    <img src="admin-assets/images/logos/insta.png" alt="" class="rounded-full h-9 w-9">
                                </div>
                                <div
                                    class="border-2 border-slate-200/50 dark:border-slate-600/60 inline-flex rounded-full cursor-pointer">
                                    <img src="admin-assets/images/logos/twitter.png" alt=""
                                        class="rounded-full h-9 w-9">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-8 xl:col-span-9">
                        <div
                            class="grid  grid-cols-1 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-4">
                            <div
                                ...
                                <div class="flex-auto p-4 text-center">
                                    <span
                                        class="inline-flex  justify-center items-center h-14 w-14 rounded-full bg-white dark:bg-gray-900 border border-dashed border-primary-500">
                                    ...
                                    <h6 class="text-gray-800 dark:text-gray-400 mb-0 text-lg font-medium uppercase">
                                        Total Cost</h6>
                                    <p class="truncate text-gray-700 dark:text-slate-500 text-sm font-normal">
                                        <span class="text-green-500">
                                            <i class="mdi mdi-checkbox-marked-circle-outline me-1"></i>
                                        </span> Last Payment <span class="text-green-500">$300.00</span>
                                    </p>
                                </div>
                                <!--end card-body-->
                            </div>
                            ...
                            <div
                                ...
                                <div class="flex-auto p-4 text-center">
                                    ...
                                    <h6 class="text-gray-800 dark:text-gray-400 text-lg mb-0 font-medium uppercase">
                                        Total Order</h6>
                                    <p class="truncate text-gray-700 dark:text-slate-500 text-sm font-normal">
                                        <span
                                            class="bg-green-600/5 text-green-500 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">3</span>
                                        Weekly Average
                                    </p>
                                </div>
                                <!--end card-body-->
                        ...
                        <div class="w-full relative mb-4">
                            <div class="flex-auto p-0 md:p-4">
                                    ...
                                    <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" aria-label="Tabs">
                                        <li class="me-2" role="presentation">
                                            <button class="inline-block p-4 rounded-t-lg border-b-2 active "
                                                id="orders-tab" data-fc-target="#orders" type="button" role="tab"
                                                aria-controls="orders" aria-selected="false">Orders <span
                                                    class="text-slate-400">(451)</span></button>
                                        </li>
                                        <li class="me-2" role="presentation">
                                            <button
                                                class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                                id="wishlist-tab" data-fc-target="#wishlist" type="button" role="tab"
                                                aria-controls="wishlist" aria-selected="false">Wishlist <span
                                                    class="text-slate-400">(155)</span></button>
                                        </li>
                                        <li class="me-2" role="presentation">
                                            <button
                                                class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300"
                                                id="ratings-tab" data-fc-target="#ratings" type="button" role="tab"
                                                aria-controls="ratings" aria-selected="false">Ratings <span
                                ...
                                <div id="myTabContent">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    ...
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#332152</a>
                                                                </td>
                                                                <td
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">Invoice</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <span
                                                                        class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">Shiped</span>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"><i
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#365214</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                    $450
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#635987</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                    $600
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#258963</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                    $850
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#321456</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                    $530
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <a href="#"
                                                                        class="text-primary-500 underline">#989896</a>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm font-medium whitespace-nowrap dark:text-white">
                                                                    $1120
                                    ...
                                    <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="wishlist"
                                    ...
                                    <div class="hidden p-4 bg-gray-50 rounded-lg dark:bg-gray-800" id="ratings"
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <ul class="flex">
                                                                        <li><i class="icofont-star text-yellow-400"></i>
                                                                        </li>
                                                                        <li><i class="icofont-star text-yellow-400"></i>
                                                                        </li>
                                                                        <li><i class="icofont-star text-yellow-400"></i>
                                                                ...
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    <span
                                                                        class="bg-green-600/5 text-green-600 text-[11px] font-medium px-2.5 py-0.5 rounded h-5">SUCCESS</span>
                                                                </td>
                                                                <td
                                                                    class="p-3 text-sm text-gray-500 whitespace-nowrap dark:text-gray-400">
                                                                    20 Feb 2023
