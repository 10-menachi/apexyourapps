    ...
    <main class="content-wrapper">
        <div class="container py-5">
            <div class="pt-1 pb-2 row pt-sm-3 pt-lg-4 pb-md-3 pb-lg-4 pb-xl-5">
                <div class="mb-5 col-lg-8 col-xl-7 mb-lg-0">
                    <div class="gap-5 accordion d-flex flex-column pe-lg-4 pe-xl-0" id="checkout">
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="w-100 ps-3 ps-md-4">
                                ...
                                <form class="needs-validation" novalidate="">
                                    <div class="mb-4 row row-cols-1 row-cols-sm-2 g-3 g-sm-4">
                                        <div class="col">
                          ...
                          &quot;classNames&quot;: {
                            &quot;containerInner&quot;: &quot;form-select form-select-lg&quot;
                                    ...
                                    <div class="mb-3">
                                        <label for="shipping-address" class="form-label">House / apartment number
                                            and street address <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control form-control-lg"
                                    ...
                                    <h3 class="h6">
                                        Billing address
                                        <i class="align-middle ci-info text-body-secondary ms-2"
                        ...
                        <!-- Payment -->
                        <div class="d-flex align-items-start">
                            <div class="flex-shrink-0 d-flex align-items-center justify-content-center bg-body-secondary text-body-secondary rounded-circle fs-sm fw-semibold lh-1"
                                style="width: 2rem; height: 2rem; margin-top: -.125rem">3</div>
                            <h2 class="mb-0 h5 text-body-secondary ps-3 ps-md-4">Payment</h2>
                        </div>
                    </div>
                </div>
