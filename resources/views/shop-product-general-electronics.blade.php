...
<body>
    ...
    <div class="modal fade" id="reviewForm" data-bs-backdrop="static" tabindex="-1" aria-labelledby="reviewFormLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content needs-validation" novalidate="">
                ...
                <div class="pt-0 pb-3 modal-body">
                    <div class="mb-3">
                ...
                <div class="gap-3 px-4 border-0 modal-footer flex-nowrap">
                    <button type="reset" class="m-0 btn btn-secondary w-100" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="m-0 btn btn-primary w-100">Submit review</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shoppingCart" tabindex="-1" aria-labelledby="shoppingCartLabel" style="width: 500px">
        ...
        <div class="gap-4 pt-2 offcanvas-body d-flex flex-column">
            ...
            <!-- Item -->
            <div class="d-flex align-items-center">
                <a class="flex-shrink-0 position-relative" href="#!">
    ...
    <header class="p-0 navbar navbar-expand-lg navbar-dark bg-dark d-block z-fixed" data-sticky-navbar="{&quot;offset&quot;: 500}">
    ...
    <main class="content-wrapper">
        ...
        <!-- Page title -->
        <h1 class="container mb-4 h3">Apple iPhone 14 Plus 128GB Blue</h1>


        <!-- Nav links + Reviews -->
        <section class="container pb-2 pb-lg-4">
            <div class="d-flex align-items-center border-bottom">
                <ul class="gap-4 nav nav-underline flex-nowrap">
                ...
                <a class="gap-2 mb-1 d-none d-md-flex align-items-center text-decoration-none ms-auto" href="#reviews">
                    <div class="gap-1 d-flex fs-sm">
        ...
        <section class="container pb-5 mb-1 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
            <div class="row">
              ...
              &quot;thumbs&quot;: {
                &quot;swiper&quot;: &quot;#thumbs&quot;
                  ...
                  <i class="ci-chevron-right fs-lg animate-target"></i>
                    ...
                    <!-- Thumbnails -->
                    <div class="pt-2 mt-1 swiper swiper-load swiper-thumbs" id="thumbs" data-swiper="{
              &quot;loop&quot;: true,
              &quot;spaceBetween&quot;: 12,
              &quot;slidesPerView&quot;: 3,
              ...
              &quot;breakpoints&quot;: {
                ...
                <!-- Product options -->
                <div class="pt-4 col-md-6 col-xl-5 offset-xl-1">
                    <div class="ps-md-4 ps-xl-0">
                        <div class="position-relative" id="zoomPane">

                            <!-- Model -->
                            <div class="pb-3 mb-2 mb-lg-3">
                                <label class="pb-1 mb-2 form-label fw-semibold">Model</label>
                            ...
                            <!-- Color -->
                            <div class="pb-3 mb-2 mb-lg-3">
                                <label class="pb-1 mb-2 form-label fw-semibold">Color: <span class="text-body fw-normal" id="colorOption">Gray blue</span></label>
                                <div class="flex-wrap gap-2 d-flex" data-binded-label="#colorOption">
                      ...
                      <span class="visually-hidden">Green</span>
                            ...
                            <div class="flex-wrap mb-3 d-flex align-items-center">
                                <div class="mb-0 h4 me-3">$940.00</div>
                            ...
                            <!-- Count + Buttons -->
                            <div class="flex-wrap gap-3 mb-4 d-flex flex-sm-nowrap flex-md-wrap flex-lg-nowrap gap-lg-2 gap-xl-3">
                                <div class="flex-shrink-0 count-input order-sm-1">
                    ...
                    Add to cart
                            ...
                            <!-- Features -->
                            <div class="flex-wrap gap-3 pb-4 mb-2 d-flex gap-xl-4 pb-lg-5 mb-lg-0 mb-xl-2">
                      ...
                      <span class="animate-target me-2">Warranty information</span>
                                ...
                                <div class="accordion-collapse collapse" id="warranty" aria-labelledby="headingWarranty" data-bs-parent="#infoAccordion">
                                    <div class="accordion-body">
                                        <div class="mb-3 alert d-flex alert-info" role="alert">
                                            <i class="mt-1 ci-check-shield fs-xl me-2"></i>
        ...
        <section class="sticky-product-banner sticky-top d-md-none" data-sticky-element="">
            <div class="pt-5 sticky-product-banner-inner">
                <div class="pt-4 pb-2 shadow bg-body border-bottom border-light border-opacity-10">
                    <div class="container d-flex align-items-center">
                        <div class="min-w-0 d-flex align-items-center ms-n2 me-3">
                            <div class="flex-shrink-0 ratio ratio-1x1" style="width: 50px">
                                <img src="assets/img/shop/electronics/thumbs/10.png" alt="iPhone 14">
                            </div>
                            <div class="min-w-0 w-100 ps-2">
                                <h4 class="mb-1 fs-sm fw-medium text-truncate">Apple iPhone 14 Plus 128GB Blue</h4>
                                <div class="mb-0 h6">$940.00</div>
                            </div>
                        </div>
        ...
        <section class="container pb-5 mb-1 mb-sm-2 mb-md-3 mb-lg-4 mb-xl-5">
            <div class="pt-5 bg-body-tertiary rounded-5">
                <h2 class="pb-2 text-center h3 py-lg-3">Cheaper together</h2>
                <div class="px-4 row justify-content-center px-md-0">
                    <div class="col-md-10">
                        <div class="overflow-auto" data-simplebar="" data-simplebar-auto-hide="false">
                            <div class="pb-4 mb-2 d-flex align-items-center justify-content-between" style="min-width: 840px">

                                <!-- Item -->
                                <div class="w-100" style="max-width: 306px">
                                    <div class="p-0 m-0 mb-3 form-check position-relative">
                                        <input type="checkbox" class="top-0 mt-3 form-check-input position-absolute end-0 me-3" id="iphone" checked="" disabled="">
                                        <label for="iphone" class="p-3 rounded d-flex justify-content-center bg-body">
                        ...
                        <span class="animate-target">Apple iPhone 14 128GB White</span>
                                ...
                                <div class="mx-3 ci-plus fs-4 mt-n5 mx-lg-4"></div>

                                <!-- Item -->
                                <div class="w-100" style="max-width: 306px">
                                    <div class="p-0 m-0 mb-3 form-check position-relative">
                                        <input type="checkbox" class="top-0 mt-3 form-check-input position-absolute end-0 me-3" id="airpods" checked="">
                                        <label for="airpods" class="p-3 rounded d-flex justify-content-center bg-body">
                        <span class="ratio d-block" style="max-width: 258px; --cz-aspect-ratio: calc(240 / 258 * 100%)">
                        ...
                        <span class="animate-target">Headphones Apple AirPods 2 Pro</span>
                                    ...
                                    <div class="gap-2 d-flex align-items-center">
                                        ...
                                        <span class="mb-0 h6">$224.00</span>
                                ...
                                <div class="w-100" style="max-width: 306px">
                                    <div class="p-0 m-0 mb-3 form-check position-relative">
                                        <input type="checkbox" class="top-0 mt-3 form-check-input position-absolute end-0 me-3" id="charger">
                                        <label for="charger" class="p-3 rounded d-flex justify-content-center bg-body">
                        <span class="ratio d-block" style="max-width: 258px; --cz-aspect-ratio: calc(240 / 258 * 100%)">
                ...
                <hr class="mb-0">
                <div class="p-4 row justify-content-center px-md-0">
                    <div class="col-md-10 d-md-flex align-items-center py-md-3">
                        <div class="mb-3 fs-sm me-3 mb-md-0">Total for selected products</div>
                        <div class="d-flex align-items-center ms-auto">
                            <span class="mb-0 h5 me-4">$1,164.00</span>
        ...
        <section class="container pb-4 mb-2 pb-md-5 mb-sm-0 mb-lg-2 mb-xl-4">
            <h2 class="pb-4 mb-0 h3 border-bottom">Trending products</h2>
            ...
            <i class="ci-chevron-right fs-lg animate-target"></i>
                ...
                <!-- Slider -->
                <div class="py-4 swiper px-sm-3" data-swiper="{
            &quot;slidesPerView&quot;: 2,
            &quot;spaceBetween&quot;: 24,
            &quot;loop&quot;: true,
            &quot;navigation&quot;: {
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <i class="ci-more-vertical fs-lg"></i>
                            ...
                            Compare
                                    ...
                                    <a class="p-3 overflow-hidden d-block rounded-top p-sm-4" href="#!">
                      <span class="top-0 mt-2 badge bg-danger position-absolute start-0 ms-2 mt-lg-3 ms-lg-3">-21%</span>
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        ...
                        <span class="animate-target">VRB01 Virtual Reality Glasses</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="mb-0 h5 lh-1">$340.99 <del class="text-body-tertiary fs-sm fw-normal">$430.00</del></div>
                        ...
                        <i class="ci-more-vertical fs-lg"></i>
                            ...
                            Compare
                                    ...
                                    <a class="p-3 overflow-hidden d-block rounded-top p-sm-4" href="#!">
                      <span class="top-0 mt-2 badge bg-info position-absolute start-0 ms-2 mt-lg-3 ms-lg-3">New</span>
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
        ...
        <section class="container pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <!-- Product details -->
                    <h2 class="pb-2 h3 pb-md-3">Product details</h2>
                    <h3 class="h6">General specs</h3>
                    <ul class="gap-3 pb-3 m-0 mb-2 list-unstyled d-flex flex-column fs-sm mb-sm-3">
                    ...
                    <ul class="gap-3 pb-1 m-0 mb-2 list-unstyled d-flex flex-column fs-sm mb-sm-3">
                        <li class="d-flex align-items-center position-relative pe-4">
                            <span>Diagonal:</span>
                            <span class="px-1 mx-2 mt-2 border-dashed d-block flex-grow-1 border-bottom"></span>
                    ...
                    <div class="nav">
                        <a class="px-0 nav-link text-primary animate-underline" href="shop-product-details-electronics.html">
                ...
                <i class="ci-chevron-right fs-base ms-1"></i>
                    ...
                    <!-- Reviews -->
                    <div class="pt-5 mt-2 mb-4 d-flex align-items-center mt-md-3 mt-lg-4" id="reviews" style="scroll-margin-top: 80px">
                        <h2 class="mb-0 h3">Reviews</h2>
                ...
                Leave a review
                    ...
                    <div class="pb-3 row g-4">
                        <div class="col-sm-4">
                            ...
                            <!-- Overall rating card -->
                            <div class="p-4 rounded d-flex flex-column align-items-center justify-content-center h-100 bg-body-tertiary">
                                <div class="pb-2 mb-1 h1">4.1</div>
                                <div class="gap-1 mb-2 hstack justify-content-center fs-sm">
                                    <i class="ci-star-filled text-warning"></i>
                                    <i class="ci-star-filled text-warning"></i>
                                    <i class="ci-star-filled text-warning"></i>
                                    <i class="ci-star-filled text-warning"></i>
                    ...
                    <div class="py-3 mb-3 border-bottom">
                        <div class="mb-3 d-flex align-items-center">
                            <div class="text-nowrap me-3">
                                <span class="mb-0 h6">Rafael Marquez</span>
                                <i class="align-middle ci-check-circle text-success ms-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-custom-class="tooltip-sm" data-bs-title="Verified customer"></i>
                            </div>
                            <span class="text-body-secondary fs-sm ms-auto">June 28, 2024</span>
                        </div>
                        <div class="gap-1 pb-2 mb-1 d-flex fs-sm">
                            <i class="ci-star-filled text-warning"></i>
                            <i class="ci-star-filled text-warning"></i>
                            <i class="ci-star-filled text-warning"></i>
                            <i class="ci-star-filled text-warning"></i>
                        ...
                        <ul class="gap-2 pb-2 mb-1 list-inline">
                        ...
                        <ul class="pb-2 mb-1 list-unstyled fs-sm">
                        ...
                        <div class="nav align-items-center">
                            <button type="button" class="px-0 nav-link animate-underline">
                  <i class="ci-corner-down-right fs-base ms-1 me-1"></i>
                  <span class="animate-target">Reply</span>
                </button>
                            <button type="button" class="px-0 nav-link text-body-secondary animate-scale ms-auto me-n1">
                  <i class="ci-thumbs-up fs-base animate-target me-1"></i>
                  0
                </button>
                            <hr class="mx-3 my-2 vr">
                            <button type="button" class="px-0 nav-link text-body-secondary animate-scale ms-n1">
                  ...
                  0
                    ...
                    <div class="py-3 mb-3 border-bottom">
                        <div class="mb-3 d-flex align-items-center">
                            <div class="text-nowrap me-3">
                                <span class="mb-0 h6">Daniel Adams</span>
                            </div>
                  ...
                  2
                    ...
                    <div class="nav">
                        <a class="px-0 nav-link text-primary animate-underline" href="shop-product-reviews-electronics.html">
                ...
                <aside class="col-md-5 col-xl-4 offset-xl-1 d-none d-md-block" style="margin-top: -100px">
                    <div class="top-0 position-sticky ps-3 ps-lg-4 ps-xl-0" style="padding-top: 100px">
                        <div class="p-3 border rounded p-lg-4">
                            <div class="mb-3 d-flex align-items-center">
                                ...
                                <div class="min-w-0 w-100 ps-2 ps-sm-3">
                                    ...
                                    <h4 class="mb-2 fs-sm fw-medium">Apple iPhone 14 Plus 128GB Blue</h4>
                                    <div class="mb-0 h5">$940.00</div>
                                </div>
                            </div>
                            <div class="gap-2 d-flex gap-lg-3">
        ...
        <section class="container pb-4 mb-2 pb-md-5 mb-sm-0 mb-lg-2 mb-xl-4">
            <h2 class="pb-4 mb-0 h3 border-bottom">Viewed products</h2>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <i class="ci-more-vertical fs-lg"></i>
                            ...
                            Compare
                                    ...
                                    <a class="p-3 overflow-hidden d-block rounded-top p-sm-4" href="#!">
                      <span class="top-0 mt-2 badge bg-danger position-absolute start-0 ms-2 mt-lg-3 ms-lg-3">-17%</span>
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        ...
                        <span class="animate-target">VRB01 Camera Nikon Max</span>
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="mb-0 h5 lh-1">$652.00 <del class="text-body-tertiary fs-sm fw-normal">$785.00</del></div>
                                        <button type="button" class="product-card-button btn btn-icon btn-secondary animate-slide-end ms-2" aria-label="Add to Cart">
                        <i class="ci-shopping-cart fs-base animate-target"></i>
                      </button>
                                    </div>
            ...
            <div class="container pt-sm-2 pt-md-3 pt-lg-4 pt-xl-5">
                <div class="row">
                    <div class="mb-5 col-md-6 col-lg-5 mb-md-0">
                        ...
                        <p class="pb-2 text-body pb-ms-3">Receive our latest updates about our products &amp; promotions</p>
                        ...
                        <ul class="gap-4 mb-3 list-unstyled d-flex flex-column ps-md-4 ps-lg-0">
                            <li class="nav flex-nowrap align-items-center position-relative">
                                ...
                                <div class="ps-3">
                                    ...
                                    <a class="p-0 nav-link fs-sm hover-effect-underline stretched-link" href="#!">5 New Cool Gadgets You Must See on Cartzilla - Cheap Budget</a>
                                </div>
                            </li>
                            <li class="nav flex-nowrap align-items-center position-relative">
                                ...
                                <div class="ps-3">
                                    ...
                                    <a class="p-0 nav-link fs-sm hover-effect-underline stretched-link" href="#!">5 Super Useful Gadgets on Cartzilla You Must Have in 2023</a>
                                </div>
                            </li>
                            <li class="nav flex-nowrap align-items-center position-relative">
                                ...
                                <div class="ps-3">
                                    ...
                                    <a class="p-0 nav-link fs-sm hover-effect-underline stretched-link" href="#!">Top 5 New Amazing Gadgets on Cartzilla You Must See</a>
                                </div>
                            </li>
                        </ul>
