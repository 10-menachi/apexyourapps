...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Electronics Store - Product General Info</title>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <form class="modal-content needs-validation" novalidate="">
                ...
                <div class="gap-3 px-4 border-0 modal-footer flex-nowrap">
                    <button type="reset" class="m-0 btn btn-secondary w-100"
    ...
    <div class="offcanvas offcanvas-end pb-sm-2 px-sm-2" id="shoppingCart" tabindex="-1"
        ...
        <div class="gap-4 pt-2 offcanvas-body d-flex flex-column">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="min-w-0 w-100 ps-2 ps-sm-3">
                    <h5 class="mb-2 d-flex animate-underline">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target" href="#!">Tablet Apple
                            iPad Pro M2</a>
                    </h5>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="min-w-0 w-100 ps-2 ps-sm-3">
                    <h5 class="mb-2 d-flex animate-underline">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target" href="#!">Smart Watch
                            Series 7, White</a>
                    </h5>
    ...
    <main class="content-wrapper">
        ...
        <section class="container pb-2 pb-lg-4">
            <div class="d-flex align-items-center border-bottom">
                ...
                <a class="gap-2 mb-1 d-none d-md-flex align-items-center text-decoration-none ms-auto"
                    href="#reviews">
            ...
            <div class="row">
              ...
              &quot;thumbs&quot;: {
                &quot;swiper&quot;: &quot;#thumbs&quot;
                    ...
                    <!-- Thumbnails -->
                    <div class="pt-2 mt-1 swiper swiper-load swiper-thumbs" id="thumbs"
                        data-swiper="{
              &quot;loop&quot;: true,
              &quot;spaceBetween&quot;: 12,
              &quot;slidesPerView&quot;: 3,
                ...
                <div class="pt-4 col-md-6 col-xl-5 offset-xl-1">
                    <div class="ps-md-4 ps-xl-0">
                        <div class="position-relative" id="zoomPane">
                            ...
                            <!-- Color -->
                            <div class="pb-3 mb-2 mb-lg-3">
                                <label class="pb-1 mb-2 form-label fw-semibold">Color: <span
                                        class="text-body fw-normal" id="colorOption">Gray blue</span></label>
                            ...
                            <!-- Count + Buttons -->
                            <div
                                class="flex-wrap gap-3 mb-4 d-flex flex-sm-nowrap flex-md-wrap flex-lg-nowrap gap-lg-2 gap-xl-3">
                        ...
                        <div class="accordion" id="infoAccordion">
                            <div class="accordion-item border-top">
                                ...
                                <div class="accordion-collapse collapse" id="warranty"
                                    ...
                                    <div class="accordion-body">
                                        <div class="mb-3 alert d-flex alert-info" role="alert">
                                            ...
                                            <div class="fs-sm"><span class="fw-semibold">Warranty:</span> 12 months
                                                of official manufacturer's warranty. Exchange/return of the product
                                                within 14 days.</div>
                                        </div>
                                        <p class="mb-0">Explore the details of our <a class="fw-medium"
                                                href="#!">product warranties here</a>, including duration,
                                            coverage, and any additional protection plans available. We prioritize your
                                            satisfaction, and our warranty
                                            information is designed to keep you informed and confident in your purchase.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="px-4 row justify-content-center px-md-0">
                    <div class="col-md-10">
                        <div class="overflow-auto" data-simplebar="" data-simplebar-auto-hide="false">
                            <div class="pb-4 mb-2 d-flex align-items-center justify-content-between"
                                ...
                                <div class="w-100" style="max-width: 306px">
                                    <div class="p-0 m-0 mb-3 form-check position-relative">
                                        <input type="checkbox"
                                            class="top-0 mt-3 form-check-input position-absolute end-0 me-3"
                                            id="iphone" checked="" disabled="">
                                        <label for="iphone"
                                            class="p-3 rounded d-flex justify-content-center bg-body">
                                    ...
                                    <h3 class="mb-2">
                                        <a class="d-block fs-sm fw-medium animate-underline text-truncate"
                                            href="#!">
                                ...
                                <div class="w-100" style="max-width: 306px">
                                    <div class="p-0 m-0 mb-3 form-check position-relative">
                                        ...
                                        <label for="charger"
                                            ...
                                            <span class="ratio d-block"
                                                style="max-width: 258px; --cz-aspect-ratio: calc(240 / 258 * 100%)">
                                                <img src="assets/img/shop/electronics/15.png"
        ...
        <section class="container pb-5 mb-2 mb-md-3 mb-lg-4 mb-xl-5">
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="nav">
                        <a class="px-0 nav-link text-primary animate-underline"
                    ...
                    <!-- Reviews -->
                    <div class="pt-5 mt-2 mb-4 d-flex align-items-center mt-md-3 mt-lg-4" id="reviews"
                    ...
                    <div class="pb-3 row g-4">
                        <div class="col-sm-4">
                            ...
                            <!-- Overall rating card -->
                            <div
                                class="p-4 rounded d-flex flex-column align-items-center justify-content-center h-100 bg-body-tertiary">
                            ...
                            <div class="gap-3 vstack">
                                ...
                                <div class="gap-2 hstack">
                                    ...
                                    <div class="progress w-100" role="progressbar" aria-label="Four stars"
                                        aria-valuenow="23.5" aria-valuemin="0" aria-valuemax="100"
                                        style="height: 4px">
                                        <div class="progress-bar bg-warning rounded-pill" style="width: 23.5%">
                                        </div>
                                    </div>
                                ...
                                <div class="gap-2 hstack">
                                    ...
                                    <div class="progress w-100" role="progressbar" aria-label="One star"
                                        aria-valuenow="3.5" aria-valuemin="0" aria-valuemax="100"
                                        style="height: 4px">
                    ...
                    <div class="py-3 mb-3 border-bottom">
                        <div class="mb-3 d-flex align-items-center">
                            <div class="text-nowrap me-3">
                                ...
                                <i class="align-middle ci-check-circle text-success ms-1" data-bs-toggle="tooltip"
                        ...
                        <ul class="gap-2 pb-2 mb-1 list-inline">
                            <li class="fs-sm me-4"><span class="text-dark-emphasis fw-medium">Color:</span> Blue
                            </li>
                        ...
                        <div class="nav align-items-center">
                            ...
                            <button type="button"
                                class="px-0 nav-link text-body-secondary animate-scale ms-auto me-n1">
                        ...
                        <div class="p-3 border rounded p-lg-4">
                            <div class="mb-3 d-flex align-items-center">
                                <div class="flex-shrink-0 ratio ratio-1x1" style="width: 110px">
                                    <img src="assets/img/shop/electronics/thumbs/10.png" width="110"
                                        alt="iPhone 14">
                                </div>
                                <div class="min-w-0 w-100 ps-2 ps-sm-3">
                                    <div class="gap-2 mb-2 d-flex align-items-center">
