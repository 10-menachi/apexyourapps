...
<body>
    ...
    <div class="offcanvas offcanvas-end" id="customizer" tabindex="-1">
        ...
        <div class="offcanvas-body">
            ...
            <div class="customizer-collapse collapse show" id="customizerSettings">
                ...
                <div class="pb-4 mb-2">
                    <div class="mb-3 d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fs-lg">Colors</h5>
                    </div>
                    <div class="row row-cols-2 g-3" id="theme-colors">
                        <div class="col">
                            <h6 class="mb-2 fs-sm">Primary</h6>
                            <div class="gap-3 p-2 border rounded color-swatch d-flex" id="theme-primary" data-color-labels="[&quot;theme-primary&quot;, &quot;primary&quot;, &quot;primary-rgb&quot;]">
                                <input type="text" class="p-1 bg-transparent border-0 form-control rounded-0" value="#f55266">
                                <label for="primary" class="flex-shrink-0 cursor-pointer ratio ratio-1x1 w-100 rounded-circle" style="max-width: 38px; background-color: #f55266"></label>
                                <input type="color" class="visually-hidden" id="primary" value="#f55266">
                            </div>
                        </div>
                        <div class="col">
                            <h6 class="mb-2 fs-sm">Success</h6>
                            <div class="gap-3 p-2 border rounded color-swatch d-flex" id="theme-success" data-color-labels="[&quot;theme-success&quot;, &quot;success&quot;, &quot;success-rgb&quot;]">
                                <input type="text" class="p-1 bg-transparent border-0 form-control rounded-0" value="#33b36b">
                                <label for="success" class="flex-shrink-0 cursor-pointer ratio ratio-1x1 w-100 rounded-circle" style="max-width: 38px; background-color: #33b36b"></label>
                                <input type="color" class="visually-hidden" id="success" value="#33b36b">
                            </div>
                        </div>
                        <div class="col">
                            <h6 class="mb-2 fs-sm">Warning</h6>
                            <div class="gap-3 p-2 border rounded color-swatch d-flex" id="theme-warning" data-color-labels="[&quot;theme-warning&quot;, &quot;warning&quot;, &quot;warning-rgb&quot;]">
                                <input type="text" class="p-1 bg-transparent border-0 form-control rounded-0" value="#fc9231">
                                <label for="warning" class="flex-shrink-0 cursor-pointer ratio ratio-1x1 w-100 rounded-circle" style="max-width: 38px; background-color: #fc9231"></label>
                                <input type="color" class="visually-hidden" id="warning" value="#fc9231">
                            </div>
                        </div>
                        <div class="col">
                            <h6 class="mb-2 fs-sm">Danger</h6>
                            <div class="gap-2 p-2 border rounded color-swatch d-flex" id="theme-danger" data-color-labels="[&quot;theme-danger&quot;, &quot;danger&quot;, &quot;danger-rgb&quot;]">
                                <input type="text" class="p-1 bg-transparent border-0 form-control rounded-0" value="#f03d3d">
                                <label for="danger" class="flex-shrink-0 cursor-pointer ratio ratio-1x1 w-100 rounded-circle" style="max-width: 38px; background-color: #f03d3d"></label>
                                <input type="color" class="visually-hidden" id="danger" value="#f03d3d">
                            </div>
                        </div>
                        <div class="col">
                            <h6 class="mb-2 fs-sm">Info</h6>
                            <div class="gap-2 p-2 border rounded color-swatch d-flex" id="theme-info" data-color-labels="[&quot;theme-info&quot;, &quot;info&quot;, &quot;info-rgb&quot;]">
                                <input type="text" class="p-1 bg-transparent border-0 form-control rounded-0" value="#2f6ed5">
                                <label for="info" class="flex-shrink-0 cursor-pointer ratio ratio-1x1 w-100 rounded-circle" style="max-width: 38px; background-color: #2f6ed5"></label>
                ...
                <div class="pb-4 mb-2">
                    <div class="pb-1 mb-2 d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fs-lg">Direction</h5>
                    </div>
                    <div class="p-3 border rounded d-flex align-items-center justify-content-between">
                        <div class="me-3">
                            <h6 class="mb-1">RTL</h6>
                            <p class="mb-0 fs-sm">Change text direction</p>
                        </div>
                        <div class="m-0 form-check form-switch">
                            <input type="checkbox" class="form-check-input" role="switch" id="rtl-switch">
                        </div>
                    </div>
                    <div class="p-2 mt-2 mb-0 alert alert-info">
                        <div class="py-1 d-flex text-body-emphasis fs-xs pe-1">
                            <i class="mb-2 ci-info text-info fs-lg mb-sm-0" style="margin-top: .125rem"></i>
                ...
                <div class="pb-4 mb-2">
                    <div class="pb-1 mb-2 d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fs-lg">Border width, px</h5>
                    </div>
                    <div class="gap-3 p-3 border rounded slider-input d-flex align-items-center" id="border-input">
                ...
                <div class="pb-1 mb-2 d-flex align-items-center">
                    ...
                    <h5 class="mb-0 fs-lg">Rounding, rem</h5>
                </div>
                <div class="gap-3 p-3 border rounded slider-input d-flex align-items-center">
            ...
            <div class="customizer-collapse collapse" id="customizerCode">
                <div class="mb-3 nav">
                    <a class="p-0 nav-link animate-underline fs-base" href=".customizer-collapse" data-bs-toggle="collapse" aria-expanded="true" aria-controls="customizerSettings customizerCode">
              <i class="ci-chevron-left fs-lg ms-n1 me-1"></i>
              <span class="animate-target">Back to settings</span>
            </a>
                </div>
                <p class="pb-1 fs-sm">To apply the provided styles to your webpage, enclose them within a <code>&lt;style&gt;</code> tag and insert this tag into the <code>&lt;head&gt;</code> section of your HTML document after the following link to the main stylesheet:<br><code>&lt;link href="assets/css/theme.min.css"&gt;</code></p>
                <div class="pt-3 overflow-hidden rounded position-relative bg-body-tertiary">
                    <div class="top-0 p-3 position-absolute start-0 w-100">
                ...
                Copy code
                    ...
                    <pre class="p-4 pt-5 bg-transparent border-0 text-wrap fs-xs text-body-emphasis" id="generated-styles"></pre>
                </div>
            </div>
        </div>

        <!-- Offcanvas footer (Action buttons) -->
        <div class="gap-3 offcanvas-header border-top d-none" id="customizer-btns">
                  ...
                  <span class="theme-icon-active d-flex animate-target">
                    <i class="ci-sun"></i>
                      ...
                      <i class="item-active-indicator ci-check ms-auto"></i>
                        ...
                        <button type="button" class="border-0 btn btn-icon btn-lg fs-xl btn-outline-secondary rounded-circle animate-shake d-lg-none" data-bs-toggle="collapse" data-bs-target="#searchBar" aria-controls="searchBar" aria-expanded="false" aria-label="Toggle search bar">
            ...
            <nav class="offcanvas offcanvas-start" id="navbarNav" tabindex="-1" aria-labelledby="navbarNavLabel">
                ...
                <div class="py-3 mt-3 offcanvas-header border-top d-md-none">
                    <a class="d-flex align-items-center text-decoration-none" href="#accountSidebar" data-bs-toggle="offcanvas" aria-controls="accountSidebar">
                        <div class="flex-shrink-0 mb-0 h5 d-flex justify-content-center align-items-center text-primary bg-primary-subtle lh-1 rounded-circle" style="width: 3rem; height: 3rem">S</div>
                        <div class="ps-3">
                            <h5 class="mb-1 h6">Susan Gardner</h5>
                            <div class="d-flex flex-nowrap fs-sm text-body">
                                <svg class="flex-shrink-0 text-warning me-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"><path d="M1.333 9.667H7.5V16h-5c-.64 0-1.167-.527-1.167-1.167V9.667zm13.334 0v5.167c0 .64-.527 1.167-1.167 1.167h-5V9.667h6.167zM0 5.833V7.5c0 .64.527 1.167 1.167 1.167h.167H7.5v-1-3H1.167C.527 4.667 0 5.193 0 5.833zm14.833-1.166H8.5v3 1h6.167.167C15.473 8.667 16 8.14 16 7.5V5.833c0-.64-.527-1.167-1.167-1.167z"></path><path d="M8 5.363a.5.5 0 0 1-.495-.573C7.752 3.123 9.054-.03 12.219-.03c1.807.001 2.447.977 2.447 1.813 0 1.486-2.069 3.58-6.667 3.58zM12.219.971c-2.388 0-3.295 2.27-3.595 3.377 1.884-.088 3.072-.565 3.756-.971.949-.563 1.287-1.193 1.287-1.595 0-.599-.747-.811-1.447-.811z"></path><path d="M8.001 5.363c-4.598 0-6.667-2.094-6.667-3.58 0-.836.641-1.812 2.448-1.812 3.165 0 4.467 3.153 4.713 4.819a.5.5 0 0 1-.495.573zM3.782.971c-.7 0-1.448.213-1.448.812 0 .851 1.489 2.403 5.042 2.566C7.076 3.241 6.169.971 3.782.971z"></path></svg>                                100 bonuses available
                            </div>
                        </div>
                    </a>
                </div>
                    ...
                    <div class="ps-lg-3 ps-xl-0">
                        ...
                        <div class="py-4 border-bottom">
                            <div class="pb-1 mb-3 nav flex-nowrap align-items-center justify-content-between">
                                ...
                                <a class="p-0 nav-link hiding-collapse-toggle text-decoration-underline collapsed" href=".basic-info" data-bs-toggle="collapse" aria-expanded="false" aria-controls="basicInfoPreview basicInfoEdit">Edit</a>
                            </div>
                        ...
                        <div class="py-4 border-bottom">
                            <div class="pb-1 mb-3 nav flex-nowrap align-items-center justify-content-between">
                                ...
                                <a class="p-0 nav-link hiding-collapse-toggle text-decoration-underline collapsed" href=".contact-info" data-bs-toggle="collapse" aria-expanded="false" aria-controls="contactInfoPreview contactInfoEdit">Edit</a>
                            </div>
                        ...
                        <div class="py-4 border-bottom">
                            <div class="pb-1 mb-3 nav flex-nowrap align-items-center justify-content-between">
                                ...
                                <a class="p-0 nav-link hiding-collapse-toggle text-decoration-underline collapsed" href=".password-change" data-bs-toggle="collapse" aria-expanded="false" aria-controls="passChangePreview passChangeEdit">Edit</a>
                            </div>
    ...
    <button type="button" class="pb-4 border-0 fixed-bottom z-sticky w-100 btn btn-lg btn-dark border-top border-light border-opacity-10 rounded-0 d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#accountSidebar" aria-controls="accountSidebar" data-bs-theme="light">
    ...
    <div class="pb-4 floating-buttons position-fixed top-50 end-0 z-sticky me-3 me-xl-4">
        ...
        <a class="shadow btn btn-sm btn-outline-secondary text-uppercase bg-body rounded-pill animate-rotate ms-2 me-n5" href="#customizer" style="font-size: .625rem; letter-spacing: .05rem;" data-bs-toggle="offcanvas" role="button" aria-controls="customizer">
