...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Account - Personal Info</title>
                            ...
                            <div class="collapse basic-info" id="basicInfoEdit">
                                <form class="row g-3 g-sm-4 needs-validation" novalidate="">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control form-icon-end"
                                                id="birthdate"
                                                data-datepicker="{
                          &quot;dateFormat&quot;: &quot;F j, Y&quot;,
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="position-relative">
                                            <input type="text" class="form-control" id="phone"
                                                ...
                                                placeholder="+1 (___) ___ __ __" value="+1 (805) 348 95 72"
                                                required="">
