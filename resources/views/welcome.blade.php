...
<body>
    ...
    <!-- banner -->
    <div class="bg-center bg-no-repeat bg-cover py-36" style="background-image: url('assets/images/banner-bg.jpg');">
        <div class="container">
    ...
    <div class="container py-16">
        <div class="grid justify-center w-10/12 grid-cols-1 gap-6 mx-auto md:grid-cols-3">
            <div class="flex items-center justify-center gap-5 px-3 py-6 border rounded-sm border-primary">
                <img src="assets/images/icons/delivery-van.svg" alt="Delivery" class="object-contain w-12 h-12">
                <div>
            ...
            <div class="flex items-center justify-center gap-5 px-3 py-6 border rounded-sm border-primary">
                <img src="assets/images/icons/money-back.svg" alt="Delivery" class="object-contain w-12 h-12">
                <div>
            ...
            <div class="flex items-center justify-center gap-5 px-3 py-6 border rounded-sm border-primary">
                <img src="assets/images/icons/service-hours.svg" alt="Delivery" class="object-contain w-12 h-12">
                <div>
