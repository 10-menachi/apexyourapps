...
<body>
        ...
        <div class="offcanvas-body d-flex flex-column gap-4 pt-2">
                ...
                <div class="w-100 min-w-0 ps-3">
                    <h5 class="d-flex animate-underline mb-2">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target"
                            href="shop-product-fashion.html">Leather sneakers with golden laces</a>
                    </h5>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="w-100 min-w-0 ps-3">
                    <h5 class="d-flex animate-underline mb-2">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target"
                            href="shop-product-fashion.html">Classic cotton men's shirt</a>
                    </h5>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="w-100 min-w-0 ps-3">
                    <h5 class="d-flex animate-underline mb-2">
                        <a class="d-block fs-sm fw-medium text-truncate animate-target"
                            href="shop-product-fashion.html">Polarized sunglasses for men</a>
                    </h5>
    ...
    <header class="navbar navbar-expand-lg navbar-sticky bg-body d-block z-fixed p-0"
        ...
        <div class="container py-2 py-lg-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="dropdown d-none d-md-block nav">
                    ...
                    <ul class="dropdown-menu fs-sm" style="--cz-dropdown-spacer: .5rem">
                        ...
                        <li>
                            <a class="dropdown-item" href="#!">
                                <img src="assets/img/flags/fr.png" class="flex-shrink-0 me-2" width="20"
                                    alt="France">
                                France
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#!">
                                <img src="assets/img/flags/de.png" class="flex-shrink-0 me-2" width="20"
                                    alt="Deutschland">
                                Deutschland
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#!">
                                <img src="assets/img/flags/it.png" class="flex-shrink-0 me-2" width="20"
                                    alt="Italia">
                                Italia
                            </a>
                        </li>
            ...
            <!-- Navbar brand (Logo) -->
            <a class="navbar-brand fs-2 py-0 m-0 me-auto me-sm-n5" href="home-fashion-v1.html">Apex</a>
                                ...
                                <div class="dropdown position-static pb-lg-2">
                                    ...
                                    <div class="dropdown-menu w-100 p-4 px-xl-5" style="--cz-dropdown-spacer: .75rem">
                                        ...
                                        <ul class="nav nav-underline justify-content-lg-center mt-n2 mt-lg-0 mb-4"
                                            ...
                                            <li class="nav-item" role="presentation">
                                                <button type="button" class="nav-link text-uppercase" id="mens-tab"
                                                    data-bs-toggle="tab" data-bs-target="#mens-tab-pane"
                                                    role="tab" aria-controls="mens-tab-pane"
                                                    aria-selected="false">
                                                    Men's
                                                </button>
                                            </li>
                                            <li class="nav-item" role="presentation">
                                                <button type="button" class="nav-link text-uppercase" id="kids-tab"
                                                    data-bs-toggle="tab" data-bs-target="#kids-tab-pane"
                                                    role="tab" aria-controls="kids-tab-pane"
                                                    aria-selected="false">
                                                    Kids'
                                                </button>
                                            </li>
                                        ...
                                        <div class="tab-content pb-xl-4">
                                            ...
                                            <!-- Women's tab -->
                                            <div class="tab-pane fade show active" id="womens-tab-pane"
                                                        ...
                                                        <ul class="nav flex-column gap-2 mt-0">
                                                            <li class="d-flex w-100 pt-1">
                                                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                                                    href="shop-catalog-fashion.html">Shirts &amp;
                                                                    Tops</a>
                                                            </li>
                                                            <li class="d-flex w-100 pt-1">
                                                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                                                    href="shop-catalog-fashion.html">Coats &amp;
                                                                    Outerwear</a>
                                                            </li>
                                                            <li class="d-flex w-100 pt-1">
                                                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-lg-2">
                                                        ...
                                                        <ul class="nav flex-column gap-2 mt-0">
                                                            ...
                                                            <li class="d-flex w-100 pt-1">
                                                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                                                    href="shop-catalog-fashion.html">Sports
                                                                    Clothing</a>
                                                            </li>
                                                            <li class="d-flex w-100 pt-1">
                                                                <a class="nav-link animate-underline animate-target d-inline fw-normal text-truncate p-0"
                                                    ...
                                                    <div class="col-lg-4 d-none d-lg-block" data-bs-theme="dark">
                                                        <div
                                                            ...
                                                            <div
                                                                class="position-relative d-flex flex-column justify-content-between h-100 z-2 pt-xl-2 ps-xl-2">
                                                                <div class="h4 lh-base">Men's<br>Sunglasses<br>Offers
                                                                </div>
                                                                <div>
                                                                    <a class="btn btn-sm btn-dark stretched-link"
                                                                        href="shop-catalog-fashion.html"
                                                ...
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-lg-4 d-none d-lg-block" data-bs-theme="light">
                                                        <div
                                                            ...
                                                            <div
                                                                class="position-relative d-flex flex-column justify-content-between h-100 z-2 pt-xl-2 ps-xl-2">
                                                                <div class="h4 lh-base">Kids'<br>Spring<br>Collection
                                                                </div>
                                                                <div>
                                                                    <a class="btn btn-sm btn-dark stretched-link"
                                                                        href="shop-catalog-fashion.html"
    ...
    <main class="content-wrapper">
        ...
        <section class="container py-5 my-2 my-sm-3 my-lg-4 my-xl-5">
            <div class="d-sm-flex align-items-center justify-content-between py-xxl-3">
                <div class="mb-4 mb-sm-0 me-sm-4">
                    ...
                    <p class="mb-0">We might already have what you're looking for. See our FAQs or head to our
                        dedicated Help Center.</p>
                </div>
        ...
        <section class="position-relative bg-body-tertiary">
            <a class="position-absolute top-50 start-50 translate-middle z-2 mt-lg-n4"
                ...
                data-bs-content="Click to view the map" data-glightbox="width: 100vw; height: 100vh;"
                data-gallery="map" aria-label="Toggle map">
