...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Account - Payment Methods</title>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="mb-3 nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button type="button" class="nav-link" id="paypal-tab" data-bs-toggle="tab"
                                data-bs-target="#paypal-tab-pane" role="tab" aria-controls="paypal-tab-pane"
                                aria-selected="false">
                                <img src="assets/img/payment-methods/paypal-icon.svg" class="me-2" width="14"
                                    alt="PayPal">
                                PayPal
                            </button>
                        </li>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="position-relative" data-input-format="{&quot;creditCard&quot;: true}">
                                        <input type="text" class="form-control form-icon-end" id="card-number"
                                            style="background-image: none" placeholder="XXXX XXXX XXXX XXXX"
                                            required="">
                                        <span
