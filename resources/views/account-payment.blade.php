<!DOCTYPE html><html lang="en" data-bs-theme="light" data-pwa="true"><head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Account - Payment Methods</title>
            ...
            <ul class="mb-3 nav nav-tabs" role="tablist">
              <li class="nav-item" role="presentation">
                <button type="button" class="nav-link active" id="card-tab" data-bs-toggle="tab" data-bs-target="#card-tab-pane" role="tab" aria-controls="card-tab-pane" aria-selected="true">
                  <i class="opacity-75 ci-credit-card fs-base ms-n2 me-2"></i>
                   Card
                </button>
              </li>
              <li class="nav-item" role="presentation">
              ...
              <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3 g-md-4 g-lg-3 g-xl-4">
                    ...
                    <div class="pb-3 card-body">
                      <div class="mb-4 d-flex align-items-start justify-content-between">
                        ...
                        <div class="nav animate-underline">
                          <a class="p-0 nav-link animate-target fs-xs" href="#!">Set as primary</a>
                        </div>
                      </div>
                ...
                <div class="col">
                  <div class="border-0 card h-100">
                    <span class="top-0 border border-opacity-25 border-dashed rounded position-absolute start-0 w-100 h-100 border-secondary d-none-dark"></span>
                    <span class="top-0 border border-opacity-25 border-dashed rounded position-absolute start-0 w-100 h-100 border-light d-none d-block-dark"></span>
                    <div class="py-5 card-body position-relative z-2 nav align-items-center justify-content-center">
                      <a class="min-w-0 px-0 nav-link animate-underline stretched-link fs-base" href="#addPaymentModal" data-bs-toggle="modal">
