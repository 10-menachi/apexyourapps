...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Checkout v.1 - Delivery Info Step 1</title>
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="w-100 ps-3 ps-md-4">
                                ...
                                <div class="ms-n5 ms-sm-0">
                                    <p class="fs-sm mb-md-4">Add your Postcode to see the delivery and collection
                                    ...
                                    <div class="d-flex flex-column flex-md-row align-items-md-end gap-3 gap-xl-4">
                                        <div class="w-100">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                id="postcode" placeholder="e.g. H1 1AG">
                                        </div>
