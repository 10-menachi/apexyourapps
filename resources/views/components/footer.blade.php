     ...
     <div class="container position-relative z-1 pt-sm-2 pt-md-3 pt-lg-4" data-bs-theme="dark">
         ...
         <div class="d-md-flex align-items-center border-top py-4">
             <div class="d-flex gap-2 gap-sm-3 justify-content-center ms-md-auto mb-4 mb-md-0 order-md-2">
                 ...
                 <div>
                     <img src="assets/img/payment-methods/mpesa-logo.svg" alt="Mpesa Payment">
                 </div>
                 <div>
                     <img src="assets/img/payment-methods/apple-pay-dark-mode.svg" alt="Apple Pay">
                 </div>
             </div>
             <p class="text-body fs-xs text-center text-md-start mb-0 me-4 order-md-1">©{{ date('Y') }} All rights
