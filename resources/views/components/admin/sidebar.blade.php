<div
    ...
    <div
        class="p-5 text-center border-b bg-[#603dc3] border-r h-[64px] flex justify-center items-center brand-logo dark:bg-[#603dc3] dark:border-slate-700/40 group-data-[sidebar=dark]:bg-[#603dc3] group-data-[sidebar=dark]:border-slate-700/40 group-data-[sidebar=brand]:bg-brand group-[.dark]:group-data-[sidebar=brand]:bg-[#603dc3] group-data-[sidebar=brand]:border-slate-700/40 m-5">
        <a href="index.html" class="logo">
            <span>
                <img src="{{ asset('logo.png') }}" alt="Logo" class="inline-block m-5 align-middle h-14 logo-sm">
            </span>
        </a>
    </div>
