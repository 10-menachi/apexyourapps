...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Electronics Store - 404 Error</title>
...
<body>
    ...
    <main class="content-wrapper d-flex align-items-center justify-content-center">
        <div class="container">
            ...
            <!-- Error message -->
            <section class="px-2 py-5 mx-auto my-2 text-center px-sm-0 my-md-3 my-lg-4 my-xl-5"
                ...
                <div class="pb-4 mx-auto mb-3" style="max-width: 524px">
                    <svg class="text-body-emphasis" viewBox="0 0 524 200" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path class="d-none-dark"
                            ...
                            fill="url(#paint0_linear_2927_3489)"></path>
                        <path class="d-none-dark"
                            d="M215.812 176.426V37.711C215.812 33.2536 219.428 29.6374 223.885 29.6374H302.338C306.795 29.6374 310.411 33.2536 310.411 37.711V176.426C310.411 180.883 306.795 184.5 302.338 184.5H223.885C219.428 184.5 215.812 180.883 215.812 176.426Z"
                            fill="url(#paint1_linear_2927_3489)"></path>
                        <path class="text-primary"
                            ...
                            fill="currentColor"></path>
                        <rect class="animate-blink text-primary" x="219.7" y="141" width="86.82" height="17.94"
                            fill="currentColor"></rect>
                        <defs>
                            <linearGradient id="paint0_linear_2927_3489" x1="209.3" y1="100"
                                x2="316.912" y2="100" gradientUnits="userSpaceOnUse">
                                <stop offset="0" stop-color="#accbee"></stop>
                                <stop offset="1" stop-color="#e7f0fd"></stop>
                            </linearGradient>
                            <linearGradient id="paint1_linear_2927_3489" x1="263.111" y1="184.5"
                                x2="263.111" y2="29.6374" gradientUnits="userSpaceOnUse">
