...
<body>
    ...
    <main class="content-wrapper d-flex align-items-center justify-content-center">
        <div class="container">
            ...
            <!-- Error message -->
            <section class="px-2 py-5 mx-auto my-2 text-center px-sm-0 my-md-3 my-lg-4 my-xl-5" style="max-width: 636px">
                <div class="pb-4 mx-auto mb-3" style="max-width: 524px">
                ...
                <a class="btn btn-lg btn-primary" href="home-electronics.html">Go to homepage</a>
            </section>
    ...
    <!-- Page footer -->
    <footer class="pt-5 pb-4 mt-2 footer mt-md-3 mt-lg-4 mt-xl-5">
