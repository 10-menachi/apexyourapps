...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Blog Grid View v.1</title>
...
<body>
        ...
        <section class="container pb-5">
            <div class="pb-5 row gy-5">
                ...
                <article class="col-md-6 col-lg-7">
                    <a class="overflow-hidden ratio d-flex hover-effect-scale rounded-4" href="blog-single-v1.html"
                    ...
                    <div class="pt-4">
                        ...
                        <h3 class="mb-0 h5">
                            <a class="hover-effect-underline" href="blog-single-v1.html">Discover how to maximize
                                your productivity with these essential tech gadgets designed for the modern home
                                office</a>
                        </h3>
                    </div>
                </article>
                ...
                <div class="gap-4 col-md-6 col-lg-5 d-flex flex-column align-content-between">
                    ...
                    <article class="hover-effect-scale position-relative d-flex align-items-center ps-xl-4 mb-xl-1">
                        <div class="w-100 pe-3 pe-sm-4 pe-lg-3 pe-xl-4">
                            ...
                            <h3 class="mb-2 h6">
                                <a class="hover-effect-underline stretched-link" href="blog-single-v1.html">Digital
                                    digest: News and views on the latest electronic products</a>
                            </h3>
                        </div>
                        <div class="overflow-hidden rounded ratio w-100"
                        ...
                        <div class="w-100 pe-3 pe-sm-4 pe-lg-3 pe-xl-4">
                            ...
                            <h3 class="mb-2 h6">
                                <a class="hover-effect-underline stretched-link"
                                    href="blog-single-v1.html">Embracing connections: How modern technology bridges
                                    gaps and builds communities</a>
                            </h3>
                        </div>
                        <div class="overflow-hidden rounded ratio w-100"
                            style="max-width: 196px; --cz-aspect-ratio: calc(140 / 196 * 100%)">
                    ...
                    <article class="hover-effect-scale position-relative d-flex align-items-center ps-xl-4 mb-xl-1">
                        <div class="w-100 pe-3 pe-sm-4 pe-lg-3 pe-xl-4">
                            ...
                            <h3 class="mb-2 h6">
                                <a class="hover-effect-underline stretched-link"
                                    href="blog-single-v1.html">Transform your home into a smart hub with the latest
                                    IoT</a>
                            </h3>
                        </div>
                        <div class="overflow-hidden rounded ratio w-100"
                ...
                <div class="col-lg-8">
                    <div class="row row-cols-1 row-cols-sm-2 gy-5">
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/05.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                    <a class="p-0 nav-link text-body fs-xs text-uppercase" href="#!">Tech
                                        tips</a>
                                    <hr class="mx-1 my-1 vr">
                                    <span class="text-body-tertiary fs-xs">September 11, 2024</span>
                                </div>
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Optimizing your
                                        workspace: The guide to an efficient and minimalist desk setup</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/06.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                    <a class="p-0 nav-link text-body fs-xs text-uppercase" href="#!">Industry
                                        trends</a>
                                    <hr class="mx-1 my-1 vr">
                                    <span class="text-body-tertiary fs-xs">September 5, 2024</span>
                                </div>
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Exploring the
                                        skies: The rise of drone photography and videography</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/07.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Connecting the
                                        dots: How IoT technology is transforming everyday life</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/08.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                    <a class="p-0 nav-link text-body fs-xs text-uppercase" href="#!">Buying
                                        guides</a>
                                    <hr class="mx-1 my-1 vr">
                                    <span class="text-body-tertiary fs-xs">August 18, 2024</span>
                                </div>
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">How to find the
                                        best deals and make secure transactions online</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/09.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                    <a class="p-0 nav-link text-body fs-xs text-uppercase" href="#!">Gadget
                                        reviews</a>
                                    <hr class="mx-1 my-1 vr">
                                    <span class="text-body-tertiary fs-xs">August 9, 2024</span>
                                </div>
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Top 10 electric
                                        kitchen appliances for modern homes</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            ...
                            <div class="pt-4">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Immersive worlds: A
                                        dive into the latest VR gear and experiences</a>
                                </h3>
                            </div>
                        </article>
                    </div>
                    ...
                    &quot;effect&quot;: &quot;fade&quot;
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            ...
                                            <img src="assets/img/blog/grid/v1/slider01.jpg"
                                                class="top-0 position-absolute start-0 w-100 h-100 object-fit-cover"
                                                alt="Image">
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="ratio ratio-16x9"></div>
                                            <img src="assets/img/blog/grid/v1/slider02.jpg"
                                                class="top-0 position-absolute start-0 w-100 h-100 object-fit-cover"
                                                alt="Image">
                                        </div>
                                    </div>
                    ...
                    &quot;navigation&quot;: {
                      ...
                      &quot;nextEl&quot;: &quot;#next-post&quot;
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <h3 class="h5">The role of philanthropy in building a better world
                                            </h3>
                                            <p class="pb-4 text-body fs-sm">Charitable contributions are a vital
                                                aspect of building a better world. These contributions come in various
                                                forms, including monetary donations, volunteering time, providing
                                                expertise...</p>
                                            <a class="btn btn-outline-light" href="blog-single-v1.html">Read
                                                more</a>
                                        </div>
                                        <div class="swiper-slide">
                                            <h3 class="h5">Supporting communities through charitable giving</h3>
                                            <p class="pb-4 text-body fs-sm">Join us on a journey of generosity as we
                    ...
                    <div class="pb-2 row row-cols-1 row-cols-sm-2 gy-5 pb-sm-0">
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/11.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Tap, pay, and go:
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/12.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">The biggest
                                        prospects for the smartphone electronics industry</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/13.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                    <a class="p-0 nav-link text-body fs-xs text-uppercase" href="#!">Product
                                        reviews</a>
                                    <hr class="mx-1 my-1 vr">
                                    <span class="text-body-tertiary fs-xs">June 27, 2024</span>
                                </div>
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">Future engineers
                                        start young: A review of the latest robotic kit for kids</a>
                                </h3>
                            </div>
                        </article>
                        ...
                        <article class="col">
                            <a class="overflow-hidden rounded ratio d-flex hover-effect-scale"
                                href="blog-single-v1.html" style="--cz-aspect-ratio: calc(305 / 416 * 100%)">
                                <img src="assets/img/blog/grid/v1/14.jpg" class="hover-effect-target"
                                    alt="Image">
                            </a>
                            <div class="pt-4">
                                <div class="gap-2 pb-2 mb-1 nav align-items-center mt-n1">
                                ...
                                <h3 class="mb-0 h5">
                                    <a class="hover-effect-underline" href="blog-single-v1.html">A detailed guide to
                                        the latest smartphones on the market</a>
                                </h3>
                            </div>
                        </article>
                    </div>
                ...
                <aside class="col-lg-4 col-xl-3 offset-xl-1" style="margin-top: -115px">
                    <div class="offcanvas-lg offcanvas-end sticky-lg-top ps-lg-4 ps-xl-0" id="blogSidebar">
                        ...
                        <div class="pt-2 offcanvas-body d-block py-lg-0">
                            ...
                            <article
                                class="py-4 hover-effect-scale position-relative d-flex align-items-center border-bottom">
                                <div class="w-100 pe-3">
                                    <h3 class="mb-0 h6 lh-base fs-sm">
                                        <a class="hover-effect-underline stretched-link"
                                            href="blog-single-v1.html">The role of philanthropy in building a better
                                            world</a>
                                    </h3>
                                </div>
                                <div class="ratio w-100"
                                    style="max-width: 86px; --cz-aspect-ratio: calc(64 / 86 * 100%)">
                            ...
                            <article
                                ...
                                <div class="w-100 pe-3">
                                    <h3 class="mb-0 h6 lh-base fs-sm">
                                        <a class="hover-effect-underline stretched-link"
                                            href="blog-single-v1.html">The biggest prospects for the smart home
                            ...
                            <article class="py-4 hover-effect-scale position-relative d-flex align-items-center">
                                <div class="w-100 pe-3">
                                    <h3 class="mb-0 h6 lh-base fs-sm">
                                        <a class="hover-effect-underline stretched-link"
                                            href="blog-single-v1.html">Behind-the-scenes stories from the world of
                                            iPhones</a>
                                    </h3>
                                </div>
                                <div class="ratio w-100"
                            ...
                            <div class="gap-2 pb-2 d-flex">
                                <a class="border-0 btn btn-icon fs-base btn-outline-secondary" href="#!"
              ...
              &quot;slidesPerView&quot;: 4
                ...
                <div class="swiper-wrapper">
                    ...
                    <article class="swiper-slide hover-effect-scale">
                        <div class="overflow-hidden rounded ratio"
                    ...
                    <article class="swiper-slide hover-effect-scale">
                        <div class="overflow-hidden rounded ratio"
                            ...
                            <img src="assets/img/blog/grid/v1/video04.jpg" class="hover-effect-target"
                                alt="Image">
                        </div>
                        <div class="pt-3 mt-1">
                    ...
                    <article class="swiper-slide hover-effect-scale">
                        <div class="overflow-hidden rounded ratio"
                            ...
                            <img src="assets/img/blog/grid/v1/video02.jpg" class="hover-effect-target"
                                alt="Image">
                        </div>
                        <div class="pt-3 mt-1">
                            <div class="mb-2 text-body-tertiary fs-xs">04:56</div>
                            <h3 class="mb-0 h6">
                                <a class="hover-effect-underline stretched-link" href="#!">Exploring the latest
                                    best smartwatch features for busy professionals</a>
                            </h3>
                        </div>
                    </article>
                    ...
                    <article class="swiper-slide hover-effect-scale">
                        <div class="overflow-hidden rounded ratio"
                            ...
                            <img src="assets/img/blog/grid/v1/video03.jpg" class="hover-effect-target"
                                alt="Image">
                        </div>
                        <div class="pt-3 mt-1">
                            <div class="mb-2 text-body-tertiary fs-xs">03:27</div>
                            <h3 class="mb-0 h6">
                                <a class="hover-effect-underline stretched-link" href="#!">Taking to the skies
                                    with the latest compact drone technology</a>
                            </h3>
                        </div>
                    </article>
                </div>
    ...
    <button type="button"
        ...
        data-bs-toggle="offcanvas" data-bs-target="#blogSidebar" aria-controls="blogSidebar"
        data-bs-theme="light">
