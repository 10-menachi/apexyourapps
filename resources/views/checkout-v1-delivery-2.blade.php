                                    ...
                                    <div class="mb-lg-4" id="shippingMethod" role="list">
                                        ...
                                        <div class="border-bottom">
                                            <div class="form-check mb-0" role="listitem" data-bs-toggle="collapse"
                                                data-bs-target="#courier" aria-expanded="true" aria-controls="courier">
                                                <label
                                                ...
                                                <div class="pb-4 ps-3 ms-2 ms-sm-3">
                                                    <div class="alert d-flex align-items-center alert-info mb-3"
                                                        ...
                                                        <div class="fs-sm">Local shipping can take up to <span
                                                                class="text-info-emphasis fw-semibold">5</span> business
                                                            days.</div>
                                                    </div>
                                                    <p class="fs-sm mb-0">Estimated date of delivery - <span
                                                            class="text-body-emphasis fw-medium">March 15, 2024</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
