        ...
        <section class="container pt-3 pt-sm-4 pt-lg-5 mt-lg-2 mt-xl-4 mt-xxl-5" id="mission"
            ...
            <div class="text-center mx-auto" style="max-width: 690px">
                ...
                <p class="fs-xl pb-2 pb-md-3 pb-lg-4">"We believe that things exist to make life easier, more pleasant and
                    ...
                    just sell household appliances and electronics, but comfort and
                    accessibility."</p>
                <img src="assets/img/about/v1/avatar.jpg" width="64" class="d-block rounded-circle mx-auto mb-3"
                    alt="Avatar">
            ...
            <div class="row pt-2 pt-sm-3 pt-md-4 pt-lg-5">
                ...
                <div class="col-md-7 col-lg-6 pt-md-3 pt-xl-4 pt-xxl-5">
                    <div class="ps-md-3 ps-lg-4 ps-xl-5 ms-xxl-4">
                        ...
                        <p class="pb-xl-3">Apex is a comprehensive solution to fulfill any customer's needs, serving as both
                            the starting point and end destination of their search. It operates as a reliable assistant,
                            dedicated to eliminating the need for any unpleasant
                                ...
                                <div class="swiper-slide w-auto h-auto">
                                    <div class="card h-100 rounded-4 px-3" style="max-width: 306px">
                                        <div class="card-body py-5 px-3">
                                            ...
                                            <p class="mb-0">Apex people are young, ambitious and energetic individuals.
