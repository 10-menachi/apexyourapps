...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Account - Notifications</title>
                        ...
                        <div class="mb-4 col-sm-6 mb-sm-0">
                            <div class="overflow-hidden text-center position-relative bg-warning rounded-4">
                                <div class="px-4 py-3 position-relative z-1">
                                    <svg class="mb-2 text-white opacity-75" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div class="bg-white position-absolute bg-opacity-10 rounded-circle"
                                ...
                                <div class="min-w-0 ps-3">
                                    ...
                                    <div class="min-w-0 nav flex-nowrap text-nowrap">
                                        <a class="p-0 nav-link animate-underline text-body" href="#bonusesModal"
                                            ...
                                            <svg class="flex-shrink-0 text-warning me-2"
                        ...
                        <div class="pb-3 mb-3 nav flex-nowrap align-items-center justify-content-between mb-lg-4">
                            ...
                            <div class="p-0 m-0 form-check form-switch nav-link animate-underline"
                                ...
                                <label for="notifications-master"
                                    class="form-check-label animate-target me-5">Unselect all</label>
                                <div class="ps-3">
                        ...
                        <div class="gap-4 d-flex flex-column" id="notifications">
                            <div class="mb-0 form-check form-switch">
                                ...
                                <label class="form-check-label ps-2" for="exclusive-offers">
                                    ...
                                    <span class="fs-sm">Receive alerts about exclusive discounts, promotions, and
                                        special offers tailored just for you.</span>
                                </label>
                            </div>
                            <div class="mb-0 form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="order-updates"
                                    checked="">
                            ...
                            <div class="mb-0 form-check form-switch">
                                ...
                                <label class="form-check-label ps-2" for="events">
                                    ...
                                    <span class="fs-sm">Receive reminders about upcoming sales events, flash sales,
                                        or product launches to make sure you're always in the loop.</span>
                                </label>
                            </div>
                            <div class="mb-0 form-check form-switch">
                                <input type="checkbox" class="form-check-input" id="account-security"
                                    checked="">
                                <label class="form-check-label ps-2" for="account-security">
                                    <span class="mb-2 d-block h6">Account security alerts</span>
                                    <span class="fs-sm">Receive notifications about any suspicious account activity
                                        or changes to your login credentials for enhanced security.</span>
                                </label>
                            </div>
                            <div class="mb-0 form-check form-switch">
                                ...
                                <label class="form-check-label ps-2" for="support">
                                    ...
                                    <span class="fs-sm">Get updates on any inquiries or support tickets you've
                                        submitted, ensuring timely resolution of any issues.</span>
                                </label>
                            </div>
                        </div>
