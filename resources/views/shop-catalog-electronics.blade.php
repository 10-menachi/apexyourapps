...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Cartzilla | Electronics Store - Catalog</title>
...
<body>
        ...
        <section class="container pb-4 accordion pb-md-5 mb-xl-3">
            <div class="border-0 accordion-item">
                <div class="accordion-header d-md-none" id="offersHeading">
                    <button type="button" class="w-auto px-3 py-2 border border-opacity-50 border-dashed rounded accordion-button fw-medium collapsed border-danger" data-bs-toggle="collapse" data-bs-target="#offers" aria-expanded="false" aria-controls="offers">
              ...
              <span class="me-2">See latest offers</span>
                ...
                <div class="accordion-collapse collapse d-md-block" id="offers" aria-labelledby="offersHeading">
                    <div class="pt-3 row g-3 g-lg-4 pt-md-0">
                        <div class="col-md-7">
                            <div class="px-5 overflow-hidden position-relative d-flex flex-column flex-sm-row align-items-center h-100 rounded-5 px-sm-0 pe-sm-4">
                                <span class="top-0 position-absolute start-0 w-100 h-100 d-none-dark rtl-flip" style="background: linear-gradient(90deg, #accbee 0%, #e7f0fd 100%)"></span>
                                <span class="top-0 position-absolute start-0 w-100 h-100 d-none d-block-dark rtl-flip" style="background: linear-gradient(90deg, #1b273a 0%, #1f2632 100%)"></span>
                                <div class="pt-4 mt-2 text-center position-relative z-1 text-sm-start pt-sm-0 ps-xl-4 mt-sm-0 order-sm-2">
                      ...
                      <i class="ci-arrow-up-right fs-base ms-1 me-n1"></i>
                        ...
                        <div class="col-md-5">
                            <div class="pt-3 overflow-hidden position-relative d-flex flex-column align-items-center justify-content-between h-100 rounded-5">
                                <span class="top-0 position-absolute start-0 w-100 h-100 d-none-dark rtl-flip" style="background: linear-gradient(90deg, #fdcbf1 0%, #fdcbf1 1%, #ffecfa 100%)"></span>
                                <span class="top-0 position-absolute start-0 w-100 h-100 d-none d-block-dark rtl-flip" style="background: linear-gradient(90deg, #362131 0%, #322730 100%)"></span>
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="d-md-flex align-items-start">
                        <div class="mt-3 mb-0 h6 fs-sm fw-normal text-nowrap translate-middle-y me-4">Found <span class="fw-semibold">732</span> items</div>
                  ...
                  $340 - $1,250
                            ...
                            <button type="button" class="px-0 bg-transparent border-0 btn btn-sm btn-secondary text-decoration-underline ms-2">
                  Clear all
                </button>
                        </div>
                    </div>
                ...
                <div class="mt-3 col-lg-3 mt-lg-0">
                    <div class="d-flex align-items-center justify-content-lg-end text-nowrap">
                        ...
                        <div style="width: 190px">
                            <select class="px-1 border-0 form-select rounded-0" data-select="{
                ...
                <aside class="col-lg-3">
                    <div class="offcanvas-lg offcanvas-start" id="filterSidebar">
                        ...
                        <span class="text-body-secondary fs-xs ms-auto">89</span>
                                    ...
                                    <div class="accordion mb-n2">
                                        <div class="border-0 accordion-item">
                                            ...
                                            <div class="accordion-header">
                                                <button type="button" class="w-auto py-2 accordion-button fs-sm fw-medium collapsed animate-underline" data-bs-toggle="collapse" data-bs-target="#more-brands" aria-expanded="false" aria-controls="more-brands" aria-label="Show/hide more brands">
                            ...
                            <div class="p-3 border rounded w-100 p-xl-4">
                                ...
                                <div class="nav d-block mt-n2">
                                    <button type="button" class="w-auto px-0 pt-2 pb-0 nav-link animate-underline fw-normal">
                      ...
                      <span class="animate-target">Green</span>
                                    ...
                                    <button type="button" class="w-auto px-0 pt-2 pb-0 mt-1 nav-link animate-underline fw-normal">
                ...
                <div class="col-lg-9">
                    <div class="pb-3 mb-3 row row-cols-2 row-cols-md-3 g-4">
                        ...
                        <i class="ci-more-vertical fs-lg"></i>
                            ...
                            Compare
                                    ...
                                    <a class="p-3 overflow-hidden d-block rounded-top p-sm-4" href="shop-product-general-electronics.html">
                      ...
                      <div class="ratio" style="--cz-aspect-ratio: calc(240 / 258 * 100%)">
                        ...
                        <i class="ci-shopping-cart fs-base animate-target"></i>
                                ...
                                <div class="p-3 pt-1 shadow product-card-details position-absolute top-100 start-0 w-100 bg-body rounded-bottom mt-n2">
                        ...
                        <div class="row align-items-center position-relative z-1">
                            <div class="pt-5 mb-2 col-md-6 pt-md-0 mb-md-0">
                                <div class="px-4 text-center text-md-start py-md-5 ps-md-5 pe-md-0 me-md-n5">
                                    ...
                                    <p class="mb-0 text-body-emphasis ps-xxl-3">Use code <span class="px-2 py-1 bg-white d-inline-block fw-semibold text-dark rounded-pill">Sale 2024</span> to get best offer</p>
                                </div>
                            </div>
                    ...
                    <div class="row row-cols-2 row-cols-md-3 g-4">
                        ...
                        <div class="col" data-bs-theme="dark">
                            <div class="px-4 pt-4 pb-4 overflow-hidden text-center d-flex flex-column align-items-center justify-content-end h-100 rounded-5 px-lg-3" style="background: #1d2c41 url(assets/img/shop/electronics/banners/background.jpg) center/cover no-repeat">
                    ...
                    <nav class="pt-3 mt-4 border-top" aria-label="Catalog pagination">
                        <ul class="pt-2 pagination pagination-lg pt-md-3">
                            <li class="page-item disabled me-auto">
                                <a class="px-2 page-link d-flex align-items-center h-100 fs-lg" href="#!" aria-label="Previous page">
                    ...
                    <span class="visually-hidden">(current)</span>
                            ...
                            <li class="page-item ms-auto">
                                <a class="px-2 page-link d-flex align-items-center h-100 fs-lg" href="#!" aria-label="Next page">
    ...
    <button type="button" class="pb-4 border-0 fixed-bottom z-sticky w-100 btn btn-lg btn-dark border-top border-light border-opacity-10 rounded-0 d-lg-none" data-bs-toggle="offcanvas" data-bs-target="#filterSidebar" aria-controls="filterSidebar" data-bs-theme="light">
