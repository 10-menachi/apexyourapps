...
@section('title', 'Electronics Store')
@section('content')
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="d-md-flex align-items-start">
                        <div class="h6 fs-sm fw-normal text-nowrap translate-middle-y mt-3 mb-0 me-4">Found <span
                        ...
                        <div class="offcanvas-body flex-column pt-2 py-lg-0">
                            ...
                            <div class="w-100 border rounded p-3 p-xl-4">
                                ...
                                <div class="nav d-block mt-n2">
                                    <button type="button"
                                        class="nav-link w-auto animate-underline fw-normal pt-2 pb-0 px-0">
                                    ...
                                    <button type="button"
                                        class="nav-link w-auto animate-underline fw-normal mt-1 pt-2 pb-0 px-0">
                                        <span class="rounded-circle me-2"
                ...
                <div class="col-lg-9">
                            ...
                            <div class="col-md-6 pt-5 pt-md-0 mb-2 mb-md-0">
                                <div class="text-center text-md-start py-md-5 px-4 ps-md-5 pe-md-0 me-md-n5">
                                    ...
                                    <p class="text-body-emphasis ps-xxl-3 mb-0">Use code <span
                                            class="d-inline-block fw-semibold text-dark bg-white rounded-pill py-1 px-2">Sale
                    ...
                    <div class="row row-cols-2 row-cols-md-3 g-4">
                        ...
                        <div class="col" data-bs-theme="dark">
                            <div class="d-flex flex-column align-items-center justify-content-end h-100 text-center overflow-hidden rounded-5 px-4 px-lg-3 pt-4 pb-4"
