                    ...
                    <div class="col-span-12 sm:col-span-12 md:col-span-12 lg:col-span-8 xl:col-span-9 mb-4">
                        <div class="w-full relative mb-4">
                            <div class="flex-auto p-0 md:p-4">
                                <div class="flex items-center">
                                    <img src="admin-assets/images/users/avatar-2.png" alt=""
                                        class="me-2 h-24 rounded-full inline-block">
                                    <div class="self-center">
                                        <h5 class="text-2xl font-semibold text-slate-700 dark:text-gray-400">Merri
                                            Diamond</h5>
                                        ...
                                        <div class="dark:text-slate-400">
                                            ...
                                            <ul class="justify-center">
                                                ...
                                                <li class="text-slate-500">Quantity :<span
                                                        class="text-slate-700 dark:text-slate-500 font-semibold">
                                                        2</span></li>
