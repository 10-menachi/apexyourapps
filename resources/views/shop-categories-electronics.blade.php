...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Apex | Electronics Store - Categories</title>
        ...
        <section class="container mb-4">
            <div class="overflow-auto" data-simplebar="" data-simplebar-auto-hide="false">
                <div class="row row-cols-6 g-0" style="min-width: 960px">
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            href="shop-catalog-electronics.html">
                            <div class="ratio" style="max-width: 164px; --cz-aspect-ratio: calc(80 / 164 * 100%)">
                                <img src="assets/img/shop/electronics/brands/apple-light-mode.svg"
                    ...
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            href="shop-catalog-electronics.html">
                            <img src="assets/img/shop/electronics/brands/motorola-light-mode.svg"
                                class="d-none-dark" alt="Motorola">
                            <img src="assets/img/shop/electronics/brands/motorola-dark-mode.svg"
                                class="d-none d-block-dark" alt="Motorola">
                        </a>
                    </div>
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            ...
                            <img src="assets/img/shop/electronics/brands/xiaomi-light-mode.svg" class="d-none-dark"
                                alt="Xiaomi">
                            <img src="assets/img/shop/electronics/brands/xiaomi-dark-mode.svg"
                                class="d-none d-block-dark" alt="Xiaomi">
                        </a>
                    </div>
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            ...
                            <img src="assets/img/shop/electronics/brands/canon-light-mode.svg" class="d-none-dark"
                                alt="Canon">
                            <img src="assets/img/shop/electronics/brands/canon-dark-mode.svg"
                                class="d-none d-block-dark" alt="Canon">
                        </a>
                    </div>
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            ...
                            <img src="assets/img/shop/electronics/brands/samsung-light-mode.svg" class="d-none-dark"
                                alt="Samsung">
                            <img src="assets/img/shop/electronics/brands/samsung-dark-mode.svg"
                                class="d-none d-block-dark" alt="Samsung">
                        </a>
                    </div>
                    <div class="col">
                        <a class="d-flex justify-content-center py-3 px-2 px-xl-3"
                            ...
                            <img src="assets/img/shop/electronics/brands/sony-light-mode.svg" class="d-none-dark"
                                alt="Sony">
                            <img src="assets/img/shop/electronics/brands/sony-dark-mode.svg"
                                class="d-none d-block-dark" alt="Sony">
                        </a>
                    </div>
                </div>
            </div>
